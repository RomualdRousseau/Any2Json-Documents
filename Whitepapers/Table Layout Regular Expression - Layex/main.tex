...
\includesvg[width=\columnwidth]{various_tables.drawio}
\end{figure}
...
\includesvg[width=\columnwidth]{table_anatomy.drawio}
\end{figure}
...
\includesvg[width=\columnwidth]{table_stream.drawio}
\end{figure}
...
\includesvg[width=\columnwidth]{layex_algorithm.drawio}
\end{figure}
...
\includesvg[width=\columnwidth]{simple_table.drawio}
\end{figure}
...
\includesvg[width=\columnwidth]{complex_table.drawio}
\end{figure}
This simple table can be described with the layex:
\[(v\$)(v+\$)((v\$)(.+\$)*(v\$))*(.+\$)(v\$)\]
Where,
